...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => project_entity_1.Project, { nullable: false, cascade: true }),
...
__decorate([
    (0, class_transformer_1.Exclude)({ toPlainOnly: true }),
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, { nullable: false, cascade: true }),
    (0, typeorm_1.JoinColumn)({ name: 'userId' }),
    __metadata("design:type", user_entity_1.User)
], ProjectUser.prototype, "user", void 0);
exports.ProjectUser = ProjectUser = __decorate([
    (0, typeorm_1.Entity)({ name: 'project-user' })
], ProjectUser);
